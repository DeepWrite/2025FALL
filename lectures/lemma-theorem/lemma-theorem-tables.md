...
<div class="jtddiagram" role="img" aria-label="좋은 논증문 구조: 서론, 정립–반정립 순환을 통한 부분결론(Lemma)들, 종합(Integration), 최종결론(Theorem).">
  ...
  <svg viewBox="0 0 1200 900" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="title desc">
    ...
    <text x="260" y="274" text-anchor="middle" class="label">정립 #1 (기존 견해)</text>

    <rect class="box" x="780" y="220" width="320" height="90"/>
    <text x="940" y="248" text-anchor="middle" class="label bold">I Say</text>
    <text x="940" y="270" text-anchor="middle" class="label">반정립 → Lemma #1</text>
    ...
    <text x="260" y="414" text-anchor="middle" class="label">정립 #2 (관련 주장)</text>

    <rect class="box" x="780" y="360" width="320" height="90"/>
    <text x="940" y="388" text-anchor="middle" class="label bold">I Say</text>
    <text x="940" y="410" text-anchor="middle" class="label">반정립 → Lemma #2</text>
    ...
    <text x="260" y="554" text-anchor="middle" class="label">정립 #3 (추가 주장)</text>

    <rect class="box" x="780" y="500" width="320" height="90"/>
    <text x="940" y="528" text-anchor="middle" class="label bold">I Say</text>
    <text x="940" y="550" text-anchor="middle" class="label">반정립 → Lemma #3</text>
...
<div class="arg-diagram" role="img" aria-label="좋은 논증문 구조: 서론, 정립–반정립 순환을 통한 Lemma들, 종합(Integration), 결론.">
  ...
  <div class="grid">
    ...
    <!-- 1번째 정립 → 반정립/Lemma -->
    <div class="lane" aria-label="1번째 정립에서 반정립과 Lemma로">
      <div class="arg-box">
      ...
      <div class="arg-box">
        ...
        <h3>핵심 반정립 제시 → 부분 결론 도출</h3>
        <div class="small">
          “그러나/반대로/이 견해는 ~를 간과한다”처럼 <b>정확히 겨냥한 반정립</b>을 제시하고,
    ...
    <!-- 2번째 정립 → 반정립/Lemma -->
    <div class="lane" aria-label="2번째 정립에서 반정립과 Lemma로">
      <div class="arg-box">
    ...
    <!-- 3번째 정립 → 반정립/Lemma -->
    <div class="lane" aria-label="3번째 정립에서 반정립과 Lemma로">
      <div class="arg-box">
        <span class="kicker">They Say · Thesis #3</span>
        <h3>정립 #3 (추가 주장)</h3>
        <div class="small">앞선 정립들과 연동되는 추가적인 통설 혹은 세부 주장입니다.</div>
      </div>
      <div class="arrow-right" aria-hidden="true">➜</div>
      <div class="arg-box">
        <span class="kicker">I Say · Anti-thesis → Lemma #3</span>
        <h3>세 번째 반정립 → 세 번째 부분 결론</h3>
...
1. **Lemma→Theorem 사다리**
   “They Say → Anti-thesis(=Lemma) × n → Theorem” 흐름을 한 눈에 보여주는 핵심 개념도. 각 반정립(anti-thesis)이 독립된 부분결론(Lemma)로 승격되고, 이것들이 종합되어 최종 결론(Theorem)으로 귀결되는 구조를 시각화했습니다.
...
<figure class="embed-responsive">
  ...
  <svg viewBox="0 0 1000 620" width="100%" role="img" aria-labelledby="fig1-title fig1-desc">
    ...
    <desc id="fig1-desc">기존 논지(They Say)에서 시작해, 반정립(Anti-thesis)을 부분결론(Lemma)으로 정식화하고, 여러 Lemma를 종합해 Theorem으로 나아가는 흐름</desc>
    <defs>
