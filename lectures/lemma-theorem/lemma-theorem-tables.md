...
<style>
  ...
  .arg-diagram { font-size:16px; line-height:1.6; margin: 1.25rem 0; color:var(--ink); }
  .arg-diagram .title { text-align:center; font-weight:700; font-size:1.35rem; margin-bottom:.5rem; }
  .arg-diagram .subtitle { text-align:center; color:var(--muted); margin:-.2rem 0 1.2rem; }
  ...
  .arg-diagram .arg-box h3 { margin:.15rem 0 .35rem; font-size:1rem; line-height:1.35; }
  .arg-diagram .kicker {
  ...
  .arg-diagram .small { font-size:.94rem; color:#1f2937; }
  .arg-diagram .hint { font-size:.85rem; color:var(--muted); margin-top:.25rem; }

  /* Theorem accent */
  .arg-diagram .theorem { border-color:var(--accent); }
  .arg-diagram .theorem h3 { color:var(--accent); }
  ...
  .arg-diagram .lane .arrow-right { text-align:center; font-size:1.35rem; color:var(--muted); }
  .arg-diagram .connector {
    text-align:center; color:var(--muted); font-size:.95rem; margin:.15rem 0 .35rem;
  }
  .arg-diagram .centered { grid-column:1 / -1; }

  /* Optional separators */
  .arg-diagram .sep { height:1px; background:rgba(0,0,0,.06); margin:.2rem 0 .75rem; }

  /* Responsive */
  @media (max-width: 799px) {
    .arg-diagram .lane { grid-template-columns: 1fr; }
    .arg-diagram .lane .arrow-right { display:none; }
  }
</style>

<div class="arg-diagram" role="group" aria-label="좋은 논증문 구조: 카드형 도해">
  <div class="title">좋은 논증문 구조</div>
  <div class="subtitle">“They Say → I Say(반론) → Lemma(부분 결론)”을 누적하여 최종 결론(Theorem)로</div>
  ...
  <div class="grid">
    ...
    <!-- 1) Cycle 1 -->
    <div class="lane" role="group" aria-label="순환 1: Thesis → Anti-thesis → Lemma">
      <div class="arg-box" aria-label="They Say · Thesis #1">
      ...
      <div class="arg-box" aria-label="I Say · Anti-thesis → Lemma #1">
    ...
    <!-- 2) Cycle 2 -->
    <div class="lane" role="group" aria-label="순환 2: Thesis → Anti-thesis → Lemma">
      <div class="arg-box" aria-label="They Say · Thesis #2">
      ...
      <div class="arrow-right" aria-hidden="true">➜</div>
      <div class="arg-box" aria-label="I Say · Anti-thesis → Lemma #2">
    ...
    <div class="connector" aria-hidden="true">⋯ (필요 시 Thesis #3 → Lemma #3, … 반복)</div>

    <div class="sep"></div>

    <!-- 3) Synthesis -->
    <div class="arg-box centered" aria-label="Synthesis · 통합">
    ...
    <!-- 4) Theorem -->
    <div class="arg-box theorem centered" aria-label="Theorem · 최종 결론">
    ...
    <!-- 5) Conclusion -->
    <div class="arg-box centered" aria-label="결론 (Conclusion)">
